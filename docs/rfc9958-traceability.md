...
|---|---|---:|---|
| KEM migration | `pqc-ml-kem`, `pqc-core::Kem` | 2-6 | API scaffold + arithmetic + FIPS 203 structure |
...
| FIPS NTT facade | `pqc_ml_kem::fips_ntt` | facade |
